...
export type Setter<T> = (props: GetterSetterProps & {
    value: T;
}) => T;
export type Getter<T> = (props: GetterSetterProps & {
    next?: boolean;
}) => T;
...
export type EnvPropertyValue = undefined | null | boolean | number | string | unknown[] | {
    [k: string]: unknown;
} | ((payload: unknown, caller?: string) => unknown) | Promise<unknown>;
export type EnvCreator = (obj: Record<string, EnvPropertyValue>, descriptor: MicroEnvDescriptor, overrides?: GetSet) => MicroEnv;
export {};
